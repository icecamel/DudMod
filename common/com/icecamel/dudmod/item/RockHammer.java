package com.icecamel.dudmod.item;
...
public class RockHammer extends ItemTool   {
   
    /** an array of the blocks this rock hammer is effective against */
    public static final Block[] blocksEffectiveAgainst = new Block[] {Block.cobblestone, Block.stoneDoubleSlab, Block.stoneSingleSlab, Block.stone, Block.sandStone, Block.cobblestoneMossy, Block.oreIron, Block.blockIron, Block.oreCoal, Block.blockGold, Block.oreGold, Block.oreDiamond, Block.blockDiamond, Block.ice, Block.netherrack, Block.oreLapis, Block.blockLapis, Block.oreRedstone, Block.oreRedstoneGlowing};

    public RockHammer(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
  ...
  //Items
    public void updateIcons(IconRegister iconRegister){
        itemIcon = iconRegister.registerIcon("DudMod:rockhammer");
    }
}
